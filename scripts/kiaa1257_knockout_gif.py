#!/usr/bin/env python3
"""
il10_knockout_gif.py  —  KIAA1257 knockout cascade GIF (30 seconds, smooth)
"""
...
def draw(f):
    ...
    ax_net.set_title(
        f"KIAA1257 Knockout Cascade — Burns Co-expression Network (NODIS, FDR 5%)\n"
        f"{phase_str}{detail}",
...
out_gif = os.path.join(FIGURES_DIR, "kiaa1257_knockout_cascade.gif")
